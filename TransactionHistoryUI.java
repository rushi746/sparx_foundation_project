...
import com.example.basicbankingapp.DB.TransactionContractDB;
import com.example.basicbankingapp.DB.TransactionHelperDB;
import com.example.basicbankingapp.Data.TransactionData;
import com.example.basicbankingapp.ListAdapters.TransactionHistoryAdapter;
import com.example.basicbankingapp.R;

import java.util.ArrayList;

public class TransactionHistoryUI extends AppCompatActivity {
    RecyclerView recyclerView;
    RecyclerView.Adapter myAdapter;
    RecyclerView.LayoutManager layoutManager;
    ArrayList<TransactionData> transactionArrayList;

    // Database
    private TransactionHelperDB dbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transactionArrayList = new ArrayList<TransactionData>();

        // Create Table in the Database
        dbHelper = new TransactionHelperDB(this);
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                transactionArrayList.add(new TransactionData(fromName, ToName, accountBalance, status));
            }
        } finally {
