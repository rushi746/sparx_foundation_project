...
import com.example.basicbankingapp.UI.UserDataUI;
...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.ViewHolder> {
    ...
    public UserListAdapter(Context context, ArrayList<UserData> list) {
        userArrayList = list;
    }
    ...
    public void onBindViewHolder(@NonNull UserListAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), UserDataUI.class);
