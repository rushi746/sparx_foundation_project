...
import com.example.basicbankingapp.DB.TransactionHelperDB;
import com.example.basicbankingapp.DB.UserHelperDB;
import com.example.basicbankingapp.Data.UserData;
import com.example.basicbankingapp.ListAdapters.SendToUserAdapter;
import com.example.basicbankingapp.R;
import com.example.basicbankingapp.DB.TransactionContractDB.TransactionEntry;
...
public class SendToUserListUI extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    // RecyclerView
    RecyclerView recyclerView;
    RecyclerView.Adapter myAdapter;
    RecyclerView.LayoutManager layoutManager;
    ArrayList<UserData> userArrayList;

    // Database
    private UserHelperDB dbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userArrayList = new ArrayList<UserData>();

        // Create Table in the Database
        dbHelper = new UserHelperDB(this);
    ...
    public void onUserClick(int position) {
        ...
        new TransactionHelperDB(this).insertTransferData(fromUserAccountName, toUserAccountName, transferAmount, 1);
        Toast.makeText(this, "Transaction Successful!!", Toast.LENGTH_LONG).show();

        startActivity(new Intent(SendToUserListUI.this, HomeScreenUI.class));
        finish();
    }
    ...
    private void calculateAmount() {
        ...
        new UserHelperDB(this).updateAmount(fromUserAccountNo, remainingAmount);
        new UserHelperDB(this).updateAmount(toUserAccountNo, increasedAmount);
    }

    @Override
    public void onBackPressed() {
        AlertDialog.Builder builder_exitButton = new AlertDialog.Builder(SendToUserListUI.this);
        builder_exitButton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton ("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick (DialogInterface dialogInterface, int i) {
                        // Transactions Cancelled
                        TransactionHelperDB dbHelper = new TransactionHelperDB(getApplicationContext());
                        ...
                        Toast.makeText(SendToUserListUI.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(SendToUserListUI.this, UsersListUI.class));
                        finish();
                    }
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                userArrayList.add(new UserData(currentName, accountNumber, phoneNumber, ifscCode, accountBalance, email));
            }
        } finally {
